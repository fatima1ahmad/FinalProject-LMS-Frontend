...
export const API_ENDPOINTS = {
  ...
  MODULES: {
    GET_BY_COURSE: "/courses/:courseId/modules", // صح
    GET_BY_ID: "/courses/modules/:id", // صح لو الراوتر عندك فعلاً بالشكل هذا
    CREATE: "/courses/:courseId/modules", // صح
    UPDATE: "/courses/modules/:id", // صح
    DELETE: "/courses/modules/:id", // صح
  },
  ASSIGNMENTS: {
    GET_ALL: "/assignments",
  ...
  ATTACHMENTS: {
    UPLOAD: "attachments/upload", // <-- لازم يكون موجود
  },
  CATEGORIES: {
    GET_ALL: "/categories",
