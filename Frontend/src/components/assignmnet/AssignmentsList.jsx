...
const AssignmentsList = ({ onViewChange }) => {
  ...
  const handleViewSubmissions = (assignmentId) => {
    // Navigate to submissions page or show in a dialog
                  ...
                  {assignments.map((assignment) => (
                    ...
                    >
                      <HoverRow>
                        ...
                        <TableCell>
                          <ScoreBadge
                            badgeContent={assignment.max_score}
                            color="primary"
                          >
                            <ScoreIcon
                              sx={{
      ...
      >
        ...
        >
          ...
          >
            ...
            <GradientButton onClick={handleUpdate} sx={{ px: 3 }}>
              Save Changes
            </GradientButton>
          </DialogActions>
        </motion.div>
          ...
          <DialogContent dividers sx={{ py: 3 }}>
            ...
            >
              <Typography variant="body2" color="textSecondary">
                ...
                student submissions for this assignment will also be deleted.
              </Typography>
            </Box>
          </DialogContent>
          <DialogActions
